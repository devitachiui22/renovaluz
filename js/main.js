/**
 * ==========================================================================
 * RENOVALUZ - CORE SCRIPT FINAL (Menu Mobile Fix, Mascote Fix)
 * Arquivo: main.js
 * ==========================================================================
 */
...
const AppController = {
    ...
    // ── MENU HAMBÚRGUER & SCROLL HEADER (FIXO) ──
    initMobileMenu() {
    ...
    // ── HERO SLIDER (CROSSFADE BACKGROUND) ──
    ...
    // ── CAROUSELS (JQUERY SLICK) BLINDADO ──
    initCarousels() {
        if(window.jQuery && typeof $.fn.slick !== 'undefined') {
            ...
            // Carrossel Luísa: Removido fade e cssEase lineares para evitar colapso no mobile
    ...
    bindDossierActionButtons() {
        ...
        if(btnAssinar) {
            btnAssinar.addEventListener('click', (e) => {
                // Remove e.preventDefault() to allow the link to navigate to Whatsapp
            });
        }
    },
